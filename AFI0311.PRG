...
DO WHILE .T.
   ...
   DO WHILE .NOT.EOF()
      ...
      *** FIN FILTROS
      ...
      @ WLINEA+07,02 SAY "Contrato            :"+CONTRATO
      @ WLINEA+08,02 SAY "Plan de Afiliacion  :"+PLAN
      @ WLINEA+09,02 SAY "Ingreso             :"+DTOC(INGCON)
      @ WLINEA+10,02 SAY "Egreso              :"+DTOC(EGRCON)
      @ WLINEA+11,02 SAY "Valido Desde        :"+DTOC(VALDES)
      @ WLINEA+12,02 SAY "Valido Hasta        :"+DTOC(VALHAS)
      @ WLINEA+13,02 SAY "Monto Afiliacion    :"+STR(MONCON,10,2)
      @ WLINEA+14,02 SAY "Responsable del Pago:"+RESPAG
      STORE WLINEA+14 TO WLINEA
      SELECT AFITITU
      SKIP
   ENDDO
   IF WSALIDA = "M"
